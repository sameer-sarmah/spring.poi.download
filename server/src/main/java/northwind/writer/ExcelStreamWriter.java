...
public class ExcelStreamWriter {
	public static String write(List<Product> products,ZipOutputStream zipOut) {
	...
	private static void createRow(Product product,CellStyle cellStyle, Row row) {
	...
	private static void createAggregateRow(double totalPrice, CellStyle cellStyle, Row row) {
		Cell rowCell = row.createCell(0);
